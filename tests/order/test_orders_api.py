...
def test_create_order_success(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    ...
    response = client.post("/api/v1/orders/", json=order_data.model_dump(mode="json"), headers={"Authorization": f"Bearer fake-token-{client.test_user_id}"})
...
def test_create_order_value_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    ...
    response = client.post(
        ...
        headers={"Authorization": f"Bearer fake-token-{client.test_user_id}"}
    )
...
def test_create_order_integrity_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_create_order_not_found(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_get_order_by_id_success(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    ...
    mock_order_service.get_order_by_id.assert_called_once_with(mocker.ANY, order_id, requesting_user_id=client.test_user_id)
...
def test_get_order_by_id_forbidden(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试用户无权查看订单。
    """
    order_id = uuid4()
...
def test_get_order_by_id_dal_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_delete_order_not_found(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试删除不存在的订单。
    """
    order_id = uuid4()
...
def test_delete_order_value_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_delete_order_integrity_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_delete_order_dal_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试Service层抛出DALError时，Router是否正确处理。
    """
    order_id = uuid4()
...
def test_cancel_order_not_found(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试取消不存在的订单。
    """
    order_id = uuid4()
...
def test_cancel_order_forbidden(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试用户无权取消的订单。
    """
    order_id = uuid4()
    ...
    mock_order_service.cancel_order.assert_called_once()

def test_cancel_order_value_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_cancel_order_integrity_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_cancel_order_dal_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试Service层抛出DALError时，Router是否正确处理。
    """
    order_id = uuid4()
...
def test_cancel_order_missing_reason(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试取消订单时缺少取消原因。
    """
    order_id = uuid4()
...
def test_confirm_order_not_found(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试确认不存在的订单。
    """
    order_id = uuid4()
    ...
    assert response.status_code == status.HTTP_404_NOT_FOUND
    assert response.json().get('detail') == "订单未找到"
    mock_order_service.confirm_order.assert_called_once()

def test_confirm_order_forbidden(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试用户无权确认的订单。
    """
    order_id = uuid4()
...
def test_confirm_order_value_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_confirm_order_integrity_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_confirm_order_dal_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试Service层抛出DALError时，Router是否正确处理。
    """
    order_id = uuid4()
...
def test_complete_order_not_found(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试完成不存在的订单。
    """
    order_id = uuid4()
    ...
    assert response.status_code == status.HTTP_404_NOT_FOUND
    assert response.json().get('detail') == "订单未找到"
    mock_order_service.complete_order.assert_called_once()

def test_complete_order_forbidden(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试用户无权完成的订单。
    """
    order_id = uuid4()
...
def test_complete_order_value_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_complete_order_integrity_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_complete_order_dal_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试Service层抛出DALError时，Router是否正确处理。
    """
    order_id = uuid4()
    ...
    assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
    assert response.json().get('detail') == "数据库操作失败: 数据库操作失败: 完成异常"
    mock_order_service.complete_order.assert_called_once()
...
def test_reject_order_not_found(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试拒绝不存在的订单。
    """
    order_id = uuid4()
...
def test_reject_order_forbidden(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试用户无权拒绝的订单。
    """
    order_id = uuid4()
...
def test_reject_order_value_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_reject_order_integrity_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_reject_order_dal_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试Service层抛出DALError时，Router是否正确处理。
    """
    order_id = uuid4()
    ...
    assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
    assert response.json().get('detail') == "数据库操作失败: 数据库操作失败: 拒绝异常"
    mock_order_service.reject_order.assert_called_once_with(
        mocker.ANY,
        order_id,
        client.test_user_id,
...
def test_update_order_status_not_found(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试更新不存在的订单状态。
    """
    order_id = uuid4()
...
def test_update_order_status_forbidden(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试用户无权更新订单状态。
    """
    order_id = uuid4()
...
def test_update_order_status_integrity_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_update_order_status_dal_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试Service层抛出DALError时，Router是否正确处理。
    """
    order_id = uuid4()
    ...
    assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
    assert response.json().get('detail') == "数据库操作失败: 数据库操作失败: 更新异常"
    mock_order_service.update_order_status.assert_called_once()

def test_update_order_status_cancel_missing_reason(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试取消订单时缺少取消原因。
    """
    order_id = uuid4()
    status_update_data = OrderStatusUpdateSchema(status="Cancelled", cancel_reason=None)
...
def test_get_my_orders_not_found(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
...
def test_get_my_orders_dal_error(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
    测试Service层抛出DALError时，Router是否正确处理。
    """
    ...
    assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
    assert response.json().get('detail') == "数据库操作失败: 数据库操作失败: 查询订单异常"
    mock_order_service.get_orders_by_user.assert_called_once()

def test_get_my_orders_general_exception(client: TestClient, mock_order_service: AsyncMock, mocker: pytest_mock.MockerFixture):
    """
